...
const configuration = {
  SiteName: 'BANCANNABIS',
  Use2DTextOver3D: true, // Change to true if you want 2D over 3D
  SiteNameSize: 0.2, // Between 0 and +
  NumberOfVerticalLines: 25,
  NumberOfDots: 5000,
  colors: {
    CanvasBackgroundColor: '#21272a',
    LettersColor: '#FFFF',
    LinesColors: ['#FFFF', '#FFFF', '#FFFF'],
    LowerLinesColors: ['#FFFF'],
    DotsColor: '#FFFF'
  }
}
///////////////////////////////
